...
// POST REQUEST
function addTodo() {
  axios.post("https://jsonplaceholder.typicode.com/todos",{title:"New Tod",completed:true})
   .then((res)=>showOutput(res))
   .catch((err)=>console.error(err))
}
...
function customHeaders() {
  ...
  axios.post("https://jsonplaceholder.typicode.com/todos",{title:"New Tod",completed:true},config)
   .then((res)=>showOutput(res))
   .catch((err)=>console.error(err))
}
...
function errorHandling() {
  axios
    .get("https://jsonplaceholder.typicode.com/todoss5",{
